...
<?php 
   if(isset($data['donate_checked'])){
     $data['donate_checked'] = $data['donate_checked'];
    }else{
         $data['donate_checked'] = 0;
    }
?>
<?php 
if(isset($ticketData->convenience_amount)){
 $ticketData->convenience_amount = $ticketData->convenience_amount;
 }else{
     $ticketData->convenience_amount = 0;
 }
?>
            ...
            <div class="row">
                <div class="col-md-8 ">
                    <div class="card checkout-card shadow-sm">
                        <div class="card-body">
                            <h4 class="mb-3">{{ $ticketData->event->name }}</h4>
                            <div class="event-img">
                        ...
                        <div class="card-body">
                            ...
                            @if($ticketData->ticket_sold!=1)
                                ...
                                <button type="button" class="btn default-btn btn-block" id="payBookAmount">Continue To
                                    Checkout</button>
                            @else
                                <button type="button" class="btn default-btn btn-block disabled">Tickets Sold</button>
                            @endif
