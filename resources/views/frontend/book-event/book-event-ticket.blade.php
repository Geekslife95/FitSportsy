                                ...
                                @foreach($daysArr as $k=>$v)
                                    ...
                                    <li>
                                        <label class="radio-label">
                                            <input type="radio" class="date_radio" name="date_radio" value="{{$v}}" {{$k==0 ? 'checked':''}} required/>
                                            <span>
        ...
        <div class="row temple-row d-none" id="template">
            <div class="col-lg-4">
                <div class="temple-details">
                    ...
                    <p class="text-success address"><small>address</small></p>
                </div>
            </div>
            ...
            <div class="col-lg-4">
                <div class="temple-check">
                    <button class="btn btn-sm btn-primary select_tickets" type="button" disabled><span class="btn__overlay">Select Ticket</span></button>
                </div>
            </div>
        </div>
@endsection
@push('scripts')
        ...
        $("#register_frm").validate({
            ...
            errorPlacement: function(error, element) {
                ...
                $("#error_modal_body").html(`
                    ...
                    <ul style="color:red;">
                        <li>Puja Time Slot is required</li>
    ...
    <script>
        $(document).on('click',".select_tickets",function(){
            ...
            $.post(url,{'_token':'{{csrf_token()}}','date':date},function(data){
            ...
            fetch(`{{ route('get-event-list',['eq'=>request('eq')]) }}`, {
                ...
                .then(data =>{
                    ...
                    if(data.data.length > 0){
                        ...
                        document.getElementById('event_list').innerHTML = `<h2 class="text-center">No Events Found.</h2>`;
                    }
                }).catch(error=>{
