...
<section class="section-area single-detail-area py-3">
    <div class="container">
        <div class="position-relative mx-auto">
            <img src="https://static.vecteezy.com/system/resources/previews/020/919/555/non_2x/sports-background-international-sports-day-illustration-graphic-design-for-the-decoration-of-gift-certificates-banners-and-flyer-vector.jpg" alt="Badminton Coaching" class="img-fluid">
        </div>

        <h2 class="mt-4">Badminton Juniors Coaching</h2>
        ...
        <button class="btn btn-primary btn-sm font-weight-bold rounded">
            Yoga
        </button>
        ...
        <div class="progress-section mb-4 mt-4">
            ...
            <div class=" p-3 bg-dark-theme mb-3">
                <div class="dark-session-item mb-3">
                    ...
                    <div class="ml-3 d-flex flex-grow-1 justify-content-between">
                        <span>8.0 Mins</span>
                ...
                <div class="dark-session-item mb-3">
                    ...
                    <div class="ml-3 d-flex flex-grow-1 justify-content-between">
                        <span>10 Mins</span>
                        <span class="text-muted">Suryanamaskar</span>
                    </div>
                </div>
                <div class="dark-session-item mb-3">
                    ...
                    <div class="ml-3 d-flex flex-grow-1 justify-content-between">
                        <span>22 Mins</span>
                        <span class="text-muted">Advanced Rallies</span>
                    </div>
                </div>
                <div class="dark-session-item mb-3">
            ...
            <div class="mt-5">
                ...
                <div class="d-flex">
                    <div class="text-center p-3 border border-dark rounded mr-2">
                        <img src="https://cdn-icons-png.flaticon.com/512/867/867329.png" alt="Badminton" style="width: 32px; height: 32px;">
                    </div>
                    <div class="text-center p-3 border border-dark rounded mr-2">
                        <img src="https://cdn-icons-png.flaticon.com/512/867/867329.png" alt="Badminton" style="width: 32px; height: 32px;">
                    </div>
