...
<div class="pt-3 pb-3 bg-white shadow-sm">
    <div class="osahan-slider">
        ...
        <div class="osahan-slider-item"><a @if($item->redirect_link != null) href="{{$item->redirect_link}} @endif"><img
...
<div class="container mt-5">
    ...
    @if(count($item->events))
        ...
        <div class="row my-5">
            <div class="col-lg-12">
                <a class="small_banner" @if($item->redirect_link != null) href="{{$item->redirect_link}} @endif" target="_blank">
    ...
    <div class="hawan_section">
        <div class="d-sm-flex align-items-center justify-content-between mt-5 mb-3 overflow-hidden">
            ...
            <a href="{{url('all-events?category='.$item->id)}}"
                class="d-sm-inline-block text-danger text-sm float-right"><b>Explore All
                    ({{count($item->events)}})</b></a>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-2">
                            ...
                            <a href="{{url('event/'.$val->id.'/'.Str::slug($val->name))}}"
                                class="btn btn-success btn-sm w-100">Book Ticket</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="d-sm-flex align-items-center justify-content-between mt-4 mb-3 overflow-hidden">
        <h1 class="h4 mb-0 float-left">Products</h1>
      ...
      <div class="modal-content">
        <div class="modal-body p-1" id="model_body">
            ...
            <a href="{{$popup->img_url}}" class="text-decoration-none">
                <img class="img-fluid w-100" src="/upload/popup/{{$popup->image}}" alt="">
            </a>
        </div>
      </div>
    </div>
